...
{
    public class QueryStringHttpTokenResolver : ITenantTokenResolver
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly string _parameterName;

        public QueryStringHttpTokenResolver(IHttpContextAccessor httpContextAccessor, string parameterName)
        {
