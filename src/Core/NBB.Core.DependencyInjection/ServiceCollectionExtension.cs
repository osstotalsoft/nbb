...
namespace NBB.Core.DependencyInjection
{
    public static class ServiceCollectionExtension
    {
        ...
        /// <param name="serviceType">The type of services to decorate.</param>
        /// <param name="decoratorType">The type to decorate existing services with.</param>
        /// /// <param name="serviceTypePredicate">Filering predicate</param>
        /// <exception cref="MissingTypeRegistrationException">If no service of the specified <paramref name="serviceType"/> has been registered.</exception>
        /// <exception cref="ArgumentNullException">If either the <paramref name="services"/>,
        /// <paramref name="serviceType"/> or <paramref name="decoratorType"/> arguments are <c>null</c>.</exception>
        public static IServiceCollection DecorateOpenGenericWhen(this IServiceCollection services, Type serviceType, Type decoratorType, Predicate<Type> serviceTypePredicate)
        {
            ...
            if (serviceType.IsOpenGeneric() && decoratorType.IsOpenGeneric())
            {
                return services.DecorateOpenGeneric(serviceType, decoratorType, serviceTypePredicate);
            }
            else
            {
                throw new Exception("serviceType and decoratorType should be open generic");
            }
        ...
        private static IServiceCollection DecorateOpenGeneric(this IServiceCollection services, Type serviceType, Type decoratorType, Predicate<Type> serviceTypePredicate = null)
        {
            if (services.TryDecorateOpenGeneric(serviceType, decoratorType, serviceTypePredicate))
            {
                return services;
            }
        ...
        private static bool TryDecorateOpenGeneric(this IServiceCollection services, Type serviceType, Type decoratorType, Predicate<Type> serviceTypePredicate = null)
        {
            ...
            var arguments = services
                ...
                .Where(descriptor => serviceTypePredicate == null || serviceTypePredicate(descriptor.ServiceType))
