...
namespace NBB.Data.EntityFramework.MultiTenancy.Tests
{
    ...
    public class MockMultitenantDbContext : MultiTenantDbContext
    {
        ...
        public MockMultitenantDbContext(ITenantService tenantService, ITenantDatabaseConfigService tenantDatabaseConfigService, MultitenantDbContextHelper multitenantDbContextHelper) : base(tenantService, tenantDatabaseConfigService, multitenantDbContextHelper)
        {
