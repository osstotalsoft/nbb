...
namespace NBB.MultiTenancy.Identification.Tests.Services
{
    public class TenantServiceTests
    {
        ...
        public void Should_Throw_TenantNotFoundException_If_All_Resolvers_Return_Null()
        {
            ...
            var sut = new TenantIdentificationService(new List<TenantIdentificationStrategy>() { identifierPair });
        ...
        public void Should_Pass_Token_And_Stop()
        {
            ...
            var sut = new TenantIdentificationService(new List<TenantIdentificationStrategy>() { firstPair, secondPair, thirdPair });
